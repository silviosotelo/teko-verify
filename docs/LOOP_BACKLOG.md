...
3. **[en curso]** Fase 2: detector **ML** de documento (ID-card) en navegador (onnxruntime-web) — el objetivo final es ML, OpenCV fue puente.
4. **[pendiente]** Polish visual trust-driven del flujo cliente (refinar copys/jerarquía tras feedback real).
5. **[pendiente]** Calibrar umbrales match/liveness; ensemble PAD anti-spoof; persistir imagen cruda; PDF multipágina (dorso pág2); orientación 180; split apellidos pegados; purgar PII de prueba.
