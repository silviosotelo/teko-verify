...
const logData: Log[] = [
    ...
    },
    {
        ...
        date: '01 Dec 2025',
        updateContent: [
            `[Fixed] / route not redirect automatically.`,
            `[Fixed] RichTextEditor onBlur issue in IssueBody`,
        ],
    },
    {
        version: '1.3.6',
        date: '30 Oct 2025',
        updateContent: [
            `[Fixed] Type issue in useInfiniteScroll hook.`,
            `[Fixed] Order of public route & protected route.`,
